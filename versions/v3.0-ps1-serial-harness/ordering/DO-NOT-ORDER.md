...
**V2.1 REVIEW HOLD:** all manufacturing, assembly, validation, and render files
have been regenerated from the final V2.1 board. Do not place an order until a
human approves the mechanical renders, BOM/CPL rotation preview, substitutions,
and live stock.
...
- Review the uploaded BOM and CPL for 65 fitted references and four DNP bare-board test pads
